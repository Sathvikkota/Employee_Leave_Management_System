...
<head>
    ...
    <link rel="stylesheet" href="man/css/index.css">
...
<body>
    ...
    <header class="header">
        ...
        <a href="#" class="logo">Infinitum<span>Connect</span></a>
        ...
        <nav class="navbar">
            <a href="/">Home</a>
			  ...
			  <a href="http://localhost:2003/man/mnglogin">Manager</a>
        </nav>
    ...
    <section class="home" id="home">
        ...
        <h2><b>Welcome To Portal</b></h2>
        <img class="home-parallax" data-speed="5" src="./image/car0.jpg" alt="">
        <a href="#" class="btn home-parallax" data-speed="7">View More</a>
    ...
    <section class="vehical" id="vehicles">
        ...
        <h1 class="heading">This Months's <span>Top Performers</span></h1>
            ...
            <div class="wrapper">
                ...
                <div class="wraper-box">
                    <div class="box active" id="car-img1">
                        <img src="./image/emp1.png" alt="" width="40" height="130">
                        <div class="content">
                            <h3>Anish</h3>
                            <div class="price"><span>Salary: </span>Rs. 1,200,000</div>
                            <p>
                                Techie
                                <span class="fa-solid fa-circle"></span>frontEnd Developer
                                <span class="fa-solid fa-circle"></span>UI Designer
                            </p>
                    ...
                    <div class="box" id="car-img2">
                        <img src="./image/emp2.png" alt="" width="20" height="130">
                        <div class="content">
                            <h3>Anish</h3>
                            <div class="price"><span>Salary: </span>Rs. 1,200,000</div>
                            <p>
                    ...
                    <div class="box" id="car-img4">
                        <img src="./image/emp2.png" alt="" width="40" height="130">
                        <div class="content">
                            <h3>Anish</h3>
                            <div class="price"><span>Salary: </span>Rs. 1,200,000</div>
                            <p>
    ...
    <section class="featured" id="featured">
        ...
        <h1 class="heading"><span>News And</span> Events</h1>
                ...
                <div class="featured-wrapper2">
                    <div class="featured-wrapper-box">
                        ...
                        <div class="box active">
                            ...
                            <div class="price">14-10-2023</div>
                            <a href="#" class="btn">check out</a>
                        </div>

                        <div class="box">
                            <img src="./image/n4.jpeg" alt="">
                            ...
                            <div class="price">20-10-2023</div>
                            <a href="#" class="btn">check out</a>
                        </div>

                        <div class="box">
                            <img src="./image/n3.jpeg" alt="">
                            <h3>Knowledge Session</h3>
                            <div class="stars">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                            ...
                            <div class="price">25-10-2023</div>
                            <a href="#" class="btn">check out</a>
                        </div>
...
<!--         <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet, nisi.</p> -->
...
<!--     subscribe section end -->
            ...
            <div class="review-wrapper">
                ...
                <div class="review-wrapper-box">
                    ...
                    <div class="box active">
                        ...
                        <div class="content">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique amet, libero soluta
                                nobis labore aut?</p>
                            <h3>john devis</h3>
                            <div class="stars">
                                <i class="fa-solid fa-star"></i>
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <iframe class="map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1781700.7626304314!2d74.91767141980161!3d29.285725544780725!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390db00b8670400b%3A0x732eaab4aaa6c143!2sHaryana!5e0!3m2!1sen!2sin!4v1676226353123!5m2!1sen!2sin"
    ...
    <section class="footer">
        ...
        <div class="footer-box-container">
            ...
            <div class="box">
                ...
                <a href="#"><i class="fa-solid fa-location-dot"></i> austria</a>
                <a href="#"><i class="fa-solid fa-location-dot"></i> rassia</a>
            </div>
            ...
            <div class="box">
                ...
                <a href="#"><i class="fa-solid fa-envelope"></i> sell24x7@gmail.com</a>
                <a href="#"><i class="fa-solid fa-location-dot"></i> haryana, india</a>
            </div>
