...
<body>
  <div class="topnav">
    ...
    <a href="mnglogout" style="float: right;">Logout</a>
    <div class="row">
  ...
  <div class="sidenav">
    <a href="mnghome">Home</a>
    <a href="managerprofile">View Profile</a>
    <a href="updatemngprofile">Update Profile</a>
    <a href="viewallemp">View All Employees</a>
    <a href="updateempstatusm">Update Employee Status</a>
    <a href="viewallreqs" class="active">View All Requests</a>
    <a href="setdecisionaction" class="active">Update Leave Requests</a>
  </div>
  <div class="content">
